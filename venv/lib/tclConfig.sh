...
TCL_CC='/home/conda/feedstock_root/build_artifacts/tk_1695505963869/_build_env/bin/aarch64-conda-linux-gnu-cc'
...
# installed.
TCL_PREFIX='/home/mani/Downloads/datasci/venv'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/mani/Downloads/datasci/venv'
...
TCL_EXTRA_CFLAGS='-ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O3 -pipe -isystem /home/mani/Downloads/datasci/venv/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/tk_1695505963869/work=/usr/local/src/conda/tk-8.6.13 -fdebug-prefix-map=/home/mani/Downloads/datasci/venv=/usr/local/src/conda-prefix -pipe -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/mani/Downloads/datasci/venv/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--allow-shlib-undefined -Wl,-rpath,/home/mani/Downloads/datasci/venv/lib -Wl,-rpath-link,/home/mani/Downloads/datasci/venv/lib -L/home/mani/Downloads/datasci/venv/lib -Wl,--export-dynamic '
...
TCL_RANLIB='/home/conda/feedstock_root/build_artifacts/tk_1695505963869/_build_env/bin/aarch64-conda-linux-gnu-ranlib'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/mani/Downloads/datasci/venv/lib -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/mani/Downloads/datasci/venv/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/mani/Downloads/datasci/venv/include'
...
# compiled.
TCL_SRC_DIR='/home/mani/Downloads/datasci/venv/include'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='{/home/mani/Downloads/datasci/venv/lib} '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/mani/Downloads/datasci/venv/lib -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/mani/Downloads/datasci/venv/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/mani/Downloads/datasci/venv/lib/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/mani/Downloads/datasci/venv/lib/libtclstub8.6.a'
